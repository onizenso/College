...
int main(int argc, char *argv[], char *envp[])
{
   ...
   *
   * sigemptyset is used to zero-out the initial mask and old mask before intializing 
   * initrmask with handlers for sigchld and sigquit
   * the call to sigprocmask adds the list of signals that both masks should block
   **/
