...
--
   ...
   begin
      ...
      (  Command,
         ...
         &  Parent_ID_Column
         &  " ="
         &  Image (Get_New_Parent_Key (Storage.all, Parent).ID)
         &  " AND NOT "
         &  Name_Column
         &  " IS NULL"
      )  );
   ...
   begin
      ...
      begin
         ...
         if Old_Parent /= New_Parent then
            --
            -- Checking  if  the  new  parent is one of its the object's
            -- descendants.
           --
            declare
   ...
   begin
      ...
      begin
         ...
         Unreference (Command, Direct_Links_Table, ID, ID);
      exception
         when No_Data =>
            Raise_Exception
            (  End_Error'Identity,
