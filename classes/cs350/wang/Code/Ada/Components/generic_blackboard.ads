...
--
-- Put_Parameters -- The  object  used  to pass additional parameters to
--                   the allocator.
--
   type Put_Parameters is record
      Pointer : Reference;      -- To the allocated block
      Index   : Storage_Count;  -- Of the first storage unit
      Length  : aliased Storage_Count;  -- The block size
   end record;
   type Put_Parameters_Ptr is access all Put_Parameters;
