...
--
   ...
   function Decode (Data : Encoded_String; Key : String) return String is
      Sequencer : Sequence;
      Dice      : Generator;
      Result    : String (1..256);
   ...
   function Encode (Text : String; Key : String) return Encoded_String is
      Sequencer : Sequence;
      Dice      : Generator;
