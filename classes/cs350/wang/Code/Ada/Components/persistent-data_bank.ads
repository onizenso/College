...
--                                                 Winter, 2002       --
--                                                                    --
--                                Last revision :  18:12 30 Mar 2008  --
--                                                                    --
...
-- transaction initiated either by Seize_Read or Seize_Write.
--
-- Returns :
--
--    The key identifying Object in Storage
--
-- Exceptions :
--
--    Data_Error - Inconsistent data base
...
--    Pointer    - To place the first child
--
-- Implementation adds the keya of the objects referenced by the  object
...
-- specify  any  object,  the result is False. Has_Dependants is allowed
-- only   within   a  transaction  initiated  either  by  Seize_Read  or
-- Seize_Write.  It  may  raise  Use_Error  otherwise. An implementation
-- shall not count references of the object to itself if any.
--
-- Returns :
--
