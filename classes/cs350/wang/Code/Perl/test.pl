...
# run with $perl test.pl  or ./test.pl with execute permission on test.pl
# or  $perl -d test.pl for debugging 
...
# Perl has dynamic typing of scalar type string and number (duck-typing)
my $var = 5.3;  # '$' is scalar static type binding 
...
my $var2 = 0;
my @var2 = ('c','d','e','f');     # implicit static type binding of array with @
print "\nvar2[0]:\t$var2[0]\n";   # access array
...
print "Enter stuff: ";
my $stuff = <stdin>;               # stdin is the keyboard
chomp($stuff);                     # remove the CR
&test($stuff, 'the hat');          # call function test
&test(5, 10);
...
#  open a file for writing ; use '>>' for append mode  
my $outfile = ">outfile";
