/* Filename: mangling.cpp
   To demonstrates how C++ compiler handles functions with the same name 

   cxx -S mangling.cpp   or  g++ -S mangling.cpp

   will  produce an assembler code file
   
   mangling.s

   which is attached to the bottom of this file
*/
...
char *nothing( char a, int b, float *c, double *d ) 
   { return 0; }
