public interface Names {
	 ...
	 final String degreeName[] = {"Ph.D.", "M.D.", "B.S.", "B.A.", "Ed.D."};
	 final String sportName[] = {"Basketball", "Table Tennis", "Swiming",
		  "Tennis", "Golf", "Hockey", "Target Shooting",
		  "VolleyBall", "Soccer", "FootBall"};
	 final String popularity[] = {"Most Popular", "Very Popular", "Popular",
		  "Not Popular"};
	 final String deptName[] = {"Math", "Business", "Computer Graphics",
		  "Dentistry", "Optomistry", "Computer Science",
		  "Pharmacy", "Engineering", "Fine Arts",
		  "MIS"};
	 final String jTitle[] = {"Accountant", "Secretary", "Web Designer", "Dentist",
	 ...
	 final String  firstName[] = {
		  ...
		  "RiString d", "Robert", "Roberto", "Rohit", "Ronald", "Ronne", "Rosa", 
