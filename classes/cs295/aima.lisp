...
;;; made changes - april 1 2010 - donna
...
(defparameter *aima-root* (truename "/home/fac/donna/public_html/cs295/aima/") ; <<<<<<<< Edit this <<<<<<
...
;;; removed wumpus from environments and from agents - donna
...
;;;; Always load the utilities  - note: took out WUMPUS per POSIX lock problem
(aima-load 'utilities)
;;;; load logic 
(aima-load 'logic)
