/* filename: sem_test.c
 ...
 Secondly, multiple semaphore operations can be performed atomically, much like 
...
{                                  /* argv holds the arguments */
    ...
    while(1)  
    {
        ...
        /* just for kicks use semctl to get actual value of semaphore */
        n_waiting = semctl(semid, 0, GETZCNT);
        printf("%d process waiting for semaphore \n", n_waiting);
